/* Os aplicativos que a franqueadora publica nas duas lojas.
   ...
   Campos:
     ...
     rx       EXPRESSÕES que casam com o estágio do aluno (o `book` do card).
              ...
              pertence a estágio nenhum do portal (o Bilíngue e os de escola).
...
window.FISK_APPS = {
  ...
  apps: [
    ...
    { nome: 'Cyber Fisk Kids Magic Way', tipo: 'cyber', blocos: ['kids'],
      ...
      android: 'com.mbr.kidsadvmw', ios: '1454792618', rx: ['magic\\s*way'] },
    { nome: 'Cyber Fisk Kids Playground XP', tipo: 'cyber', blocos: ['kids'],
      ...
      android: 'com.mbr.cyberplaygroundxp', ios: '1551331541', rx: ['playground'] },
    { nome: 'Cyber Fisk Kids Fun XP', tipo: 'cyber', blocos: ['kids'],
      ...
      android: 'com.fisk.cyberkidsfunxp', ios: '6474543564', rx: ['fun\\s*at\\s*(home|school)', 'fun\\s*around\\s*town'] },
    { nome: 'Cyber Fisk Teens', tipo: 'cyber', blocos: ['teens'],
      ...
      android: 'com.mbr.cyberfiskteens', ios: '1496598511', rx: ['teens?\\s*connect', 'teens?\\s*elementary', 'elementary\\s*[12]', 'teen\\s*station|teenstation']},
    { nome: 'Cyber Fisk 3.0', tipo: 'cyber', blocos: ['adultos', 'espanhol'],
      ...
      android: 'com.mbr.cyber30', ios: '1491785193', rx: ['essentials', 'transitions?', 'fluency', 'in\\s*focus', 'speed\\s*[123]', 'inmediato']},
    { nome: 'Cyber PBF 4.0', tipo: 'cyber', blocos: ['pbf'],
      ...
      android: 'com.FISK.CyberPBF4', ios: '1576558734', rx: [] },
    ...
    { nome: 'Cyber Diversión Inmediato 1', tipo: 'fun', blocos: ['espanhol'],
      ...
      android: 'com.mbr.funinmediato1', ios: '1446744336', rx: ['inmediato\\s*1'] },
    { nome: 'Cyber Diversión Inmediato 2', tipo: 'fun', blocos: ['espanhol'],
      ...
      android: 'com.mbr.funinmediato2', ios: '1447231275', rx: ['inmediato\\s*2'] },
    ...
    { nome: 'Fisk RA Hello A', tipo: 'ra', blocos: ['kids'], onde: 'Playground Hello A',
      ...
      android: 'com.Mirage.FiskHelloAAR', ios: '1551687036', rx: ['playground\\s*hello\\s*a', 'hello\\s*a'] },
    { nome: 'Fisk RA Hello B', tipo: 'ra', blocos: ['kids'], onde: 'Playground Hello B',
      desc: 'Aponta a câmera para a página e a atividade ganha vida, com o Buddy.',
      android: 'com.Mirage.FiskRAHelloB', ios: '1577350854', rx: ['playground\\s*hello\\s*b', 'hello\\s*b'] },
    ...
    { nome: 'My Buddy Fisk', tipo: 'geral', blocos: ['kids'],
      ...
      android: 'com.manifesto.mybuddyfisk', ios: '1266673805', rx: ['magic\\s*way', 'playground', 'fun\\s*at', 'chiquiteens', 'con[eé]ctate']},
    { nome: 'List of Verbs', tipo: 'geral', blocos: ['teens', 'adultos'],
      ...
      android: 'com.mbr.listOfVerbs', ios: '1276545843', rx: ['teens?\\s*connect', 'elementary', 'teen\\s*station|teenstation', 'essentials', 'transitions?', 'fluency', 'in\\s*focus', 'speed'] },
    ...
    { nome: 'Fisk QR Code', tipo: 'geral', blocos: ['kids', 'adultos', 'espanhol'],
      ...
      android: 'com.mbr.fiskqrcode', ios: '1031702838', rx: ['playground\\s*(slide|see|merry|maze)', 'slide', 'see.?saw', 'merry', 'maze', 'speed', 'essentials', 'transitions?', 'fluency', 'in\\s*focus', 'inmediato'] },
    { nome: 'Fisk e-book Speed', tipo: 'geral', blocos: ['adultos'],
      onde: 'Speed 1, 2 e 3', desc: 'O leitor dos livros da série Speed.',
      android: 'com.mbr.NewFiskeBook', ios: '1585643280', rx: ['speed'] },
    ...
    { nome: 'Fisk Helper', tipo: 'escola', blocos: ['escola'],
      ...
      android: 'com.slidehelper.fisk', ios: null, rx: [] },
    { nome: 'New Fisk Player', tipo: 'escola', blocos: ['escola'],
      ...
      android: 'com.mbr.playerfisk', ios: null, rx: [] }
  ],
